...
#warning placeholder stuff, replace with card-specific information }
        ...
        self.userInfoLabel.translatesAutoresizingMaskIntoConstraints = NO;
        self.userInfoLabel.textColor = [UIColor colorWithString:@"#575757"];
        self.userInfoLabel.text = @"Allison,22";
        self.userInfoLabel.font = [UIFont systemFontOfSize:17];
        [self.userInfoLabel layoutMarginLeftSuperView:40];
        [self.userInfoLabel layoutMarginBottomSuperView:10];
